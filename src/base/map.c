...
struct hashmap *hashmap_create_with_allocator(void *(*_malloc)(size_t),
...
struct hashmap *hashmap_create(size_t elsize, size_t cap, uint64_t seed0,
    ...
    void *udata)
{
    return hashmap_create_with_allocator(NULL, NULL, NULL, elsize, cap, seed0,
...
static bool resize0(struct hashmap *map, size_t new_cap) {
    struct hashmap *map2 = hashmap_create_with_allocator(map->malloc, map->realloc,
